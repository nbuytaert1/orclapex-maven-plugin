...
public class NaturalDocsMojo extends AbstractMojo {
    ...
    /**
     * The path to the folder containing the NaturalDocs executable.
     */
     ...
     * directories and all its subdirectories. You can specify it multiple times
    ...
    /**
     * The folder in which Natural Docs will generate the documentation.
     */
